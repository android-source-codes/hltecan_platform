...
LOCAL_SRC_FILES := JackCommand.cpp
LOCAL_CFLAGS := $(common_cflags) 
LOCAL_CFLAGS += -DENABLE_JACK_LOGGER
LOCAL_LDFLAGS := $(common_ldflags) $(JACK_STL_LDFLAGS)
LOCAL_C_INCLUDES := $(common_c_includes)
LOCAL_C_INCLUDES += $(JACK_ROOT)/../../frameworks/apa/include/apa
LOCAL_SHARED_LIBRARIES := libc libdl libcutils libutils libbinder libapa libjackservice libjacklogger
LOCAL_MODULE_PATH := $(TARGET_OUT_OPTIONAL_EXECUTABLES)
LOCAL_MODULE_TAGS := eng optional
LOCAL_MODULE := jackc
